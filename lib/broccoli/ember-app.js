...
EmberApp.prototype._initOptions = function(options) {
  ...
  var appTree = new WatchedDir(this._resolveLocal('src'));
  ...
  var stylesTree = new UnwatchedDir(this._resolveLocal('src/ui/styles'));
  var templatesPath = this._resolveLocal('src/ui');
